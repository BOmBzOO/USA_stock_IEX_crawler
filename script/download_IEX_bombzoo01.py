...
def get_tickers(path):
    ...
    df = pd.read_csv(base_url.format(os.environ['TOKEN_bombzoo01']))
...
def asyncio_prep(date_str):
    ...
    api_urls = [base_url.format(ticker, date_str, os.environ['TOKEN_bombzoo01']) for ticker in tickers]
...
if __name__ == '__main__':
    ...
    with open('config_bombzoo01.json') as config_file:
        data = json.load(config_file)
        os.environ['TOKEN_bombzoo01'] = data['TOKEN']

    init_logging()
    # todo_dates = get_dates()
    todo_dates = ['20200803','20200804','20200805','20200806','20200807']
    print(todo_dates)
